...
def parse():
    ...
    parser.add_argument('-b', '--batch-size', type=int, default=4, help='Batch size')#4
    parser.add_argument('-e', '--num-epochs', type=int, default=60, help='Number of epochs')#can't over 4 at google colab
    parser.add_argument('-l', '--lr', type=float, default=45e-5, help='Learning rate')#originally e-3
